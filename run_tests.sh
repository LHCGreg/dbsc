...
nunit-console "dbsc.Core.Tests/bin/Debug/dbsc.Core.Tests.dll" "mongodbsc.Integration/bin/Debug (x86)/mongodbsc.Integration.dll" "pgdbsc.Integration/bin/Debug (x86)/pgdbsc.Integration.dll" "mydbsc.Integration/bin/Debug (x86)/mydbsc.Integration.dll" -nologo -noxml "-out=test_stdout.txt" "-err=test_stderr.txt"