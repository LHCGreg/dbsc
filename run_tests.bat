...
nunit-console-x86 "dbsc.Core.Tests/bin/Debug_AnyCPU/dbsc.Core.Tests.dll" "msdbsc.Integration/bin/Debug_x86/msdbsc.Integration.dll" "mongodbsc.Integration/bin/Debug_AnyCPU/mongodbsc.Integration.dll" "pgdbsc.Integration/bin/Debug_AnyCPU/pgdbsc.Integration.dll" "mydbsc.Integration/bin/Debug_AnyCPU/mydbsc.Integration.dll" -nologo -noxml "-out=test_stdout.txt" "-err=test_stderr.txt"